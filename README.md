# Container Chaos: Amazon Product Rating Prediction Challenge

## Overview

This competition challenges participants to build a resilient machine learning system that predicts Amazon product ratings while handling data drift through continuous learning. You'll fetch data, train models, deploy containerized APIs, detect drift, and retrain models in a production-like environment.

## Problem Statement

Predict product ratings based on customer reviews and product features. As customer behavior and product trends evolve, your model must adapt to distribution shifts in the data.
...
- **Label Request Endpoint**: `POST https://container-chaos-b2c6bde72854.herokuapp.com/amazon/production/outputs` - Submit drifted features, receive ground truth labels
...
- Consider NLP techniques for review text processing
- Handle categorical features appropriately (product categories, brands)
- Monitor for seasonal trends and promotional periods that may cause drift
